...
List<SliderModel> getSlides() {
  ...
  //1
  sliderModel.setLogo("assets/logo_autopay_white.png");
  sliderModel.setDesc("Topup ke wallet bikin transaksi cepat\ndan lancar.");
  sliderModel.setTitle("Topup Sekali Banyak Untungnya");
  sliderModel.setBgAssetPath("assets/bg_walkthrough_1.png");
  sliderModel.setImageAssetPath("assets/il_walkthrough_1.png");
  ...
  sliderModel.setBgAssetPath("assets/bg_walkthrough_2.png");
  sliderModel.setImageAssetPath("assets/il_walkthrough_2.png");
  slides.add(sliderModel);
  ...
  sliderModel.setBgAssetPath("assets/bg_walkthrough_3.png");
  sliderModel.setImageAssetPath("assets/il_walkthrough_3.png");
  slides.add(sliderModel);
  ...
  sliderModel.setBgAssetPath("assets/bg_walkthrough_4.png");
  sliderModel.setImageAssetPath("assets/il_walkthrough_4.png");
  slides.add(sliderModel);
